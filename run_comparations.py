...
# data loader
parser.add_argument('--data', type=str, default='custom_Calce', help='dataset type:custom_NoCorrection, custom_NoCorrection_Calce, custom, custom_Calce')
...
if __name__ == '__main__':
    ...
    for x in args.model_list:
        args.model = x
        for main_dir in ['data/Calce/BJDST','data/Calce/DST','data/Calce/FUDS','data/Calce/US06']:
