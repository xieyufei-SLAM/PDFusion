...
parser.add_argument('--root_path', type=str, default=r'F:\LSTF_Projects\PatchTST_supervised\data\Li_ion\hppc', help='root path of the data file')
parser.add_argument('--data_path', type=str, default=r'1号ncm电池hppc实验（复测）.xlsx', help='data file')
